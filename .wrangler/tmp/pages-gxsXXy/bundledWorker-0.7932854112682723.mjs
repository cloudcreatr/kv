// .wrangler/tmp/bundle-TyioJv/checked-fetch.js
  ...
  async fetch(request) {
    ...
    if (url.searchParams.has("set")) {
      ...
      return new Response(`updated hello ${value2}`, {
        headers: {
          "set-cookie": `om=${value2}; path=/; secure; httponly; samesite=lax`
        }
      });
    }
...
// .wrangler/tmp/bundle-TyioJv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TyioJv/middleware-loader.entry.ts
